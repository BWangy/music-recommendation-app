const AUTH_URL =
  "https://accounts.spotify.com/authorize?client_id=f7dfe6e6cd314d8c83dbf81b737932b4&show_dialog=true&response_type=code&redirect_uri=http://localhost:3000/callback&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state%20playlist-read-private%20user-top-read";
